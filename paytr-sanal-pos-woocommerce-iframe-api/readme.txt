...
== Changelog ==
= 3.1.2 = (14.05.2026)
* Update - Hata günlükleri sayfasında iyileştirme yapılmıştır.
* Update - Hatalarda e-posta bildirim seçeneği eklenilmiştir.
...
* Update - Vade farkı Woocommerce standart vergi oranını çekerek sipariş detay sayfasında vergi sütununa vergi tutarı işleniyor.
